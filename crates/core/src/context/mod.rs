...
//!
//! [`ast`] traz a extração de símbolos (MT-18); grafo de referências
//! (MT-19), ranking de relevância (MT-20) e a tool `repo_map` exposta ao
//! agent loop (MT-21) chegam nos micro-tickets seguintes.
